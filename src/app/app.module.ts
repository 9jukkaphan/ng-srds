...
import { AuthorService } from './pages/authors/author.service';
...
const routes: Routes = [
  { 
    ...
    path: 'all-authors',
    loadChildren: './pages/authors/all-authors/all-authors.module' 
  },{ 
    path: 'author-details/:id',
    loadChildren: './pages/authors/author-details/author-details.module' 
  },{ 
    path: 'all-categories',
    loadChildren: './pages/categories/all-categories/all-categories.module' 
  },{ 
    path: 'all-papers',
    loadChildren: './pages/papers/all-papers/all-papers.module' 
  }
];
